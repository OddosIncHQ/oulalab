...
const UI_STRINGS = {
  ...
  en: {
    ...
    waitlist_button: 'Secure your spot',
  ...
  pt: {
    ...
    waitlist_email: 'Mail',
    waitlist_address: 'Comuna',
    waitlist_button: 'Garanta seu lugar',

      ...
      <>
        ...
        <section className="py-40 bg-black text-white relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
            ...
            <h2 className="text-7xl sm:text-9xl md:text-[10rem] lg:text-[14rem] font-black italic tracking-tighter uppercase mb-10 leading-[0.8] text-white">{t.launch_month} <span className="text-white/10">{t.launch_year}</span></h2>

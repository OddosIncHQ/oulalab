  ...
  en: {
    ...
    team: [
      ...
      },
      {
        ...
        description: 'Currently the Vice president of Huawei Cloud Latam, he has been linked to the technology world for more than 25 years in various roles at Accenture and EY. Angel investor in several startups and limited partner in two VCs, making him an expert in the digital ecosystem.',
